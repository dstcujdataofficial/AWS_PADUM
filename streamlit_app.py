...
# Google Sheet CSV link
CSV_URL = "https://docs.google.com/spreadsheets/d/1Agg1g6cvpvByUCQdjSX-rNM79Xlh8sCC5fQZqZQxpmU/export?format=csv&gid=401181943"
...
st.markdown("""
    <div class="fixed-header">
        <div class="header-container">
            ...
            <div class="header-title">AUTOMATIC WEATHER STATION (PADUM, LADAKH)</div>
            <div class="header-subtitle">Department of Geoinformatics (Central University of Jharkhand)</div>
            </div>
...
if nr_col in plot_df.columns:
    ...
    if not plot_df[nr_col].isna().all():
        ...
        fig_nr = px.line(
            ...
            y=nr_col,
            color="Date",
            title="Net Radiation Over Time (by Date)",
            markers=True
        )

        fig_nr.update_xaxes(dtick=4)  # every 2 hours
        fig_nr.update_yaxes(title="Net Radiation (W/m²)")
